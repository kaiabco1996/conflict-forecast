...
class ConflictForecastServiceImplV2 : ConflictForecastServiceV2 {
     ...
     * @param geoPointPairMap geopoints and their trajectories.
     * @param geodeticCalc supporting object for geodetic calculations.
     * @param geoPointRegionMap contains the trajectories and the separation regions they belong to.
     * @return The map of trajectories and their regions
     */
    ...
    /**
     * evaluate the trajectories that fall within the required timestamp
     * @param trajectory contains the trajectories to analyse.
     * @param timestamp current timestamp to evaluate on.
     * @param geodeticCalc supporting object for geodetic calculations.
     * @param geoPointPairMap trajectory pairs of timestamp and their geopoints.
     * @return The map of trajectory geopoint pairs and their timestamps
     */
