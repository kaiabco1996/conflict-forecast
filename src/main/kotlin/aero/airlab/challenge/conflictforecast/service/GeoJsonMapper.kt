...
interface GeoJsonMapper {
    ...
    suspend fun createConflictsAsFeatureCollectionsV2(conflictForecastRequest: ConflictForecastRequest): Map<String, Any>
    ...
    fun createLineStringFeature(name: String, trajectoryId: Int, startPoint: TemporalGeoPoint, endPoint: TemporalGeoPoint?, r: Int,
                                g: Int,
                                b: Int): Map<String, Any>
}